		...
		<div class="container">
			<div class="row-fluid">
				<div class="span8 well">
					<p>We would love to hear from you! Please fill out the following form or email your questions or comments to admin@bookiewookie.com, or view our <a href="faq.php">FAQ</a> page to see if your question has already been answered</p>
					<div>
						<form>
    						<fieldset>
